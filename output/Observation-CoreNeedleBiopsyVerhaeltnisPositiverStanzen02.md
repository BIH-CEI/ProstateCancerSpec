# Verhältnis positiver Stanzen 02 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Verhältnis positiver Stanzen 02**

## Example Observation: Verhältnis positiver Stanzen 02
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyVerhaeltnisPositiverStanzen02",
  "meta" : {
    "profile" : [
