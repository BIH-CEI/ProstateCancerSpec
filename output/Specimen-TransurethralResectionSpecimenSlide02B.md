# HE-Schnitt 02B TUR-Prostata - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HE-Schnitt 02B TUR-Prostata**

## Example Specimen: HE-Schnitt 02B TUR-Prostata
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E2024_003-HE-02B
...
**parent**: [Specimen: identifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E2024_003-Block-02; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E2024_003; status = available; type = Paraffin block (physical object)](Specimen-TransurethralResectionSpecimenBlock02.md)
...
```json
{
  ...
  "id" : "TransurethralResectionSpecimenSlide02B",
  "meta" : {
    "profile" : [
