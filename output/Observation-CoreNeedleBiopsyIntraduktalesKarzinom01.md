# Intraduktales Karzinom Stanze 01 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Intraduktales Karzinom Stanze 01**

## Example Observation: Intraduktales Karzinom Stanze 01
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyIntraduktalesKarzinom01",
  "meta" : {
    "profile" : [
