# Invasive Cribriform Carcinoma - TUR - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Invasive Cribriform Carcinoma - TUR**

## Example Observation: Invasive Cribriform Carcinoma - TUR
...
```json
{
  ...
  "id" : "TransurethralResectionInvasiveCribriformCarcinoma",
  "meta" : {
    "profile" : [
