# Tumorbefall in Länge Stanze 07 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tumorbefall in Länge Stanze 07**

## Example Observation: Tumorbefall in Länge Stanze 07
...
**value**: 14.8 mm (Details: UCUM codemm = 'mm')
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyTumorbefallinLaenge07",
  "meta" : {
    "profile" : [
