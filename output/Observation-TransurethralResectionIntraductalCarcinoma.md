# Intraductal Carcinoma - TUR - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Intraductal Carcinoma - TUR**

## Example Observation: Intraductal Carcinoma - TUR
...
```json
{
  ...
  "id" : "TransurethralResectionIntraductalCarcinoma",
  "meta" : {
    "profile" : [
