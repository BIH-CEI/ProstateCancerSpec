# Lymphovaskuläre Invasion Stanze 09 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Lymphovaskuläre Invasion Stanze 09**

## Example Observation: Lymphovaskuläre Invasion Stanze 09
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyLymphovaskulaereInvasion09",
  "meta" : {
