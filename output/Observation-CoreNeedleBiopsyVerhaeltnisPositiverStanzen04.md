# Verhältnis positiver Stanzen 04 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Verhältnis positiver Stanzen 04**

## Example Observation: Verhältnis positiver Stanzen 04
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyVerhaeltnisPositiverStanzen04",
  "meta" : {
    "profile" : [
