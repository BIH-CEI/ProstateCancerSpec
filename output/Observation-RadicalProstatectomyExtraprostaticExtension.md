# Extraprostatic Extension - Prostatectomy - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Extraprostatic Extension - Prostatectomy**

## Example Observation: Extraprostatic Extension - Prostatectomy
...
```json
{
  ...
  "id" : "RadicalProstatectomyExtraprostaticExtension",
  "meta" : {
    "profile" : [
