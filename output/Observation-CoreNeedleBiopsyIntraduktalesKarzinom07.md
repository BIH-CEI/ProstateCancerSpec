# Intraduktales Karzinom Stanze 07 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Intraduktales Karzinom Stanze 07**

## Example Observation: Intraduktales Karzinom Stanze 07
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyIntraduktalesKarzinom07",
  "meta" : {
    "profile" : [
