# Anzahl Zylinder Stanze 07 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Anzahl Zylinder Stanze 07**

## Example Observation: Anzahl Zylinder Stanze 07
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyMacroscopicCylinderCount07",
  "meta" : {
    "profile" : [
