# Intraduktales Karzinom Stanze 04 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Intraduktales Karzinom Stanze 04**

## Example Observation: Intraduktales Karzinom Stanze 04
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyIntraduktalesKarzinom04",
  "meta" : {
    "profile" : [
