# Ratio of Positive to Total Cores - Biopsy - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Ratio of Positive to Total Cores - Biopsy**

## Example Observation: Ratio of Positive to Total Cores - Biopsy
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyRatioPositiveCores",
  "meta" : {
    "profile" : [
