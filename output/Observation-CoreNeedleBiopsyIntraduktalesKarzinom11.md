# Intraduktales Karzinom Stanze 11 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Intraduktales Karzinom Stanze 11**

## Example Observation: Intraduktales Karzinom Stanze 11
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyIntraduktalesKarzinom11",
  "meta" : {
