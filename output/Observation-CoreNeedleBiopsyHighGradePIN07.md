# High-grade PIN Stanze 07 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **High-grade PIN Stanze 07**

## Example Observation: High-grade PIN Stanze 07
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyHighGradePIN07",
  "meta" : {
    "profile" : [
