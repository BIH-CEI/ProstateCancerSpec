# Histological Differentiation Grade WHO - Biopsy - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Histological Differentiation Grade WHO - Biopsy**
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyHistologicalGradeWHO",
  "meta" : {
    "profile" : [
