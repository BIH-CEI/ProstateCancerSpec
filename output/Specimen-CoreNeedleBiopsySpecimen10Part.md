# Prostatastanze 10 - Links medial basal - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Prostatastanze 10 - Links medial basal**

## Example Specimen: Prostatastanze 10 - Links medial basal
...
* type: Structure of basal part of anterior fibromuscular stroma of left half prostate (body structure)
* description: Markiert mit silberner Tinte

**identifier**: Placer Identifier/BX24_001_10_A, Filler Identifier/E2024_001-10-A
...
| * | [Practitioner Andreas Weber](Practitioner-UrologistPractitioner.md) | 2024-01-15 10:48:00+0100 | Tru-cut biopsy of prostate (procedure) | Structure of basal part of anterior fibromuscular stroma of left half prostate (body structure) |
...
```json
{
  ...
  "id" : "CoreNeedleBiopsySpecimen10Part",
  "meta" : {
    "profile" : [
  ...
  "extension" : [
    {
      "extension" : [
        ...
        {
          "url" : "description",
          "valueString" : "Markiert mit silberner Tinte"
        }
      ],
