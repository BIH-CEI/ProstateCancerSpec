# Lymphovascular Invasion - TUR - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Lymphovascular Invasion - TUR**

## Example Observation: Lymphovascular Invasion - TUR
...
```json
{
  ...
  "id" : "TransurethralResectionLymphovascularInvasion",
  "meta" : {
    "profile" : [
