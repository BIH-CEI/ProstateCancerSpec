# HE-Schnitt Stanze 01 - Prostate Cancer Specification v0.1.0
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_24_001_A_1_1HE
...
**parent**: [Specimen: identifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_24_001_A_1; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_24_001; status = available; type = General specimen container (physical object)](Specimen-CoreNeedleBiopsySpecimen01Block.md)
...
```json
{
  ...
  "id" : "CoreNeedleBiopsySpecimen01Slide",
  "meta" : {
