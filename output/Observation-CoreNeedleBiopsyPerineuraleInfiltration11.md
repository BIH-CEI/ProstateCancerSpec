# Perineurale Infiltration Stanze 11 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Perineurale Infiltration Stanze 11**

## Example Observation: Perineurale Infiltration Stanze 11
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyPerineuraleInfiltration11",
  "meta" : {
