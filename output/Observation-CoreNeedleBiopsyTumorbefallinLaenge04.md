# Tumorbefall in Länge Stanze 04 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tumorbefall in Länge Stanze 04**

## Example Observation: Tumorbefall in Länge Stanze 04
...
**value**: 12.8 mm (Details: UCUM codemm = 'mm')
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyTumorbefallinLaenge04",
  "meta" : {
    "profile" : [
