# Prozentualer Anteil Gleasonmuster 4/5 Stanze 01 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Prozentualer Anteil Gleasonmuster 4/5 Stanze 01**

## Example Observation: Prozentualer Anteil Gleasonmuster 4/5 Stanze 01
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyProzentGleason01",
  "meta" : {
    "profile" : [
