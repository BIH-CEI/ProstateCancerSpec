# Primäres Gleason Muster Stanze 09 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Primäres Gleason Muster Stanze 09**

## Example Observation: Primäres Gleason Muster Stanze 09
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyPrimaerGleason09",
  "meta" : {
