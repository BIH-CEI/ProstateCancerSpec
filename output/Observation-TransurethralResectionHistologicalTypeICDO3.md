# Histological Type ICD-O-3 - TUR-Prostata - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Histological Type ICD-O-3 - TUR-Prostata**

## Example Observation: Histological Type ICD-O-3 - TUR-Prostata
...
```json
{
  ...
  "id" : "TransurethralResectionHistologicalTypeICDO3",
  "meta" : {
    "profile" : [
