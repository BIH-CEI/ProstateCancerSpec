# Granulomatöse Prostatitis Stanze 07 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Granulomatöse Prostatitis Stanze 07**

## Example Observation: Granulomatöse Prostatitis Stanze 07
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyGranulomatoeseProstatitis07",
  "meta" : {
    "profile" : [
