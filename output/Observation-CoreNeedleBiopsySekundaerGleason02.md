# Sekundäres Gleason Muster Stanze 02 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Sekundäres Gleason Muster Stanze 02**

## Example Observation: Sekundäres Gleason Muster Stanze 02
...
```json
{
  ...
  "id" : "CoreNeedleBiopsySekundaerGleason02",
  "meta" : {
    "profile" : [
