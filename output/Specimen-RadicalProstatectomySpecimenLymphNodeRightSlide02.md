# HE-Schnitt Lymphknoten rechts 02 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HE-Schnitt Lymphknoten rechts 02**

## Example Specimen: HE-Schnitt Lymphknoten rechts 02
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_24_002_B_1_2HE
...
| :--- | :--- | :--- |
| - | **Collected[x]** | **Method** |
| * | 2024-03-17 08:35:00+0100 | Tissue processing technique (procedure) |

> **processing****MII EX Biobank Temperaturbedingungen**: 2-8 °C**description**: Schnittherstellung**procedure**: Sectioning of tissue specimen (procedure)**time**: 2024-03-17 09:35:00+0100

> **processing****description**: HE-Färbung**procedure**: Hematoxylin and eosin staining method (procedure)**time**: 2024-03-17 09:50:00+0100
...
```json
{
  ...
  "id" : "RadicalProstatectomySpecimenLymphNodeRightSlide02",
  "meta" : {
    "profile" : [
