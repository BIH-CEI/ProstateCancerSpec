# Tumornachweis Samenblasen Stanze 04 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tumornachweis Samenblasen Stanze 04**

## Example Observation: Tumornachweis Samenblasen Stanze 04
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyTumornachweisinSamenblase04",
  "meta" : {
    "profile" : [
