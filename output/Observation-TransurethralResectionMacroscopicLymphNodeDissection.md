# Lymphknoten-Dissektion im TUR-Resektat - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Lymphknoten-Dissektion im TUR-Resektat**

## Example Observation: Lymphknoten-Dissektion im TUR-Resektat
...
```json
{
  ...
  "id" : "TransurethralResectionMacroscopicLymphNodeDissection",
  "meta" : {
    "profile" : [
