# Tumornachweis Fettgewebe Stanze 04 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tumornachweis Fettgewebe Stanze 04**

## Example Observation: Tumornachweis Fettgewebe Stanze 04
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyTumornachweisInFettgewebe04",
  "meta" : {
    "profile" : [
