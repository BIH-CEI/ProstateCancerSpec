# Makroskopische Länge Stanze 11 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Makroskopische Länge Stanze 11**

## Example Observation: Makroskopische Länge Stanze 11
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyMacroscopicLength11",
  "meta" : {
    "profile" : [
