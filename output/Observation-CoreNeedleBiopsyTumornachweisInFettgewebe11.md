# Tumornachweis Fettgewebe Stanze 11 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tumornachweis Fettgewebe Stanze 11**

## Example Observation: Tumornachweis Fettgewebe Stanze 11
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyTumornachweisInFettgewebe11",
  "meta" : {
