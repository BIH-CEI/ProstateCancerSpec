# Paraffinblock 01 TUR-Prostata - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Paraffinblock 01 TUR-Prostata**

## Example Specimen: Paraffinblock 01 TUR-Prostata
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E2024_003-Block-01
...
```json
{
  ...
  "id" : "TransurethralResectionSpecimenBlock01",
  "meta" : {
    "profile" : [
