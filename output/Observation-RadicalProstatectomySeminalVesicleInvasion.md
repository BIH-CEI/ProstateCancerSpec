# Seminal Vesicle Invasion - Prostatectomy - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Seminal Vesicle Invasion - Prostatectomy**

## Example Observation: Seminal Vesicle Invasion - Prostatectomy
...
```json
{
  ...
  "id" : "RadicalProstatectomySeminalVesicleInvasion",
  "meta" : {
    "profile" : [
