# High-grade PIN Stanze 01 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **High-grade PIN Stanze 01**

## Example Observation: High-grade PIN Stanze 01
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyHighGradePIN01",
  "meta" : {
    "profile" : [
