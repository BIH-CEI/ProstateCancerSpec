# Intraduktales Karzinom Stanze 06 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Intraduktales Karzinom Stanze 06**

## Example Observation: Intraduktales Karzinom Stanze 06
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyIntraduktalesKarzinom06",
  "meta" : {
