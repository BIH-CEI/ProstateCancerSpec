# HE-Schnitt Lymphknoten rechts 01 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HE-Schnitt Lymphknoten rechts 01**

## Example Specimen: HE-Schnitt Lymphknoten rechts 01
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_24_002_B_1_1HE
...
**parent**: [Specimen: identifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_24_002_B_1; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_24_002; status = available; type = Tissue block specimen (specimen)](Specimen-RadicalProstatectomySpecimenLymphNodeRightBlock.md)
...
| :--- | :--- | :--- |
| - | **Collected[x]** | **Method** |
| * | 2024-03-17 08:30:00+0100 | Tissue processing technique (procedure) |

> **processing****MII EX Biobank Temperaturbedingungen**: 2-8 °C**description**: Schnittherstellung**procedure**: Sectioning of tissue specimen (procedure)**time**: 2024-03-17 09:30:00+0100

> **processing****description**: HE-Färbung**procedure**: Hematoxylin and eosin staining method (procedure)**time**: 2024-03-17 09:45:00+0100
...
```json
{
  ...
  "id" : "RadicalProstatectomySpecimenLymphNodeRightSlide01",
  "meta" : {
    "profile" : [
