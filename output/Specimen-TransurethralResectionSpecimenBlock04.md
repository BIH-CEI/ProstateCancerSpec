# Paraffinblock 04 TUR-Prostata - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Paraffinblock 04 TUR-Prostata**

## Example Specimen: Paraffinblock 04 TUR-Prostata
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E2024_003-Block-04
...
```json
{
  ...
  "id" : "TransurethralResectionSpecimenBlock04",
  "meta" : {
    "profile" : [
