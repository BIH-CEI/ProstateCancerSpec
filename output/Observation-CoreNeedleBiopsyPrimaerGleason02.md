# Primäres Gleason Muster Stanze 02 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Primäres Gleason Muster Stanze 02**

## Example Observation: Primäres Gleason Muster Stanze 02
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyPrimaerGleason02",
  "meta" : {
    "profile" : [
