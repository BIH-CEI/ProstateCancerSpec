# Prozentualer Anteil Gleasonmuster 4/5 Stanze 07 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Prozentualer Anteil Gleasonmuster 4/5 Stanze 07**

## Example Observation: Prozentualer Anteil Gleasonmuster 4/5 Stanze 07
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyProzentGleason07",
  "meta" : {
    "profile" : [
