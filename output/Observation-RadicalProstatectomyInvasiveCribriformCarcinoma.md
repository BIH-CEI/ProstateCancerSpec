# Invasive Cribriform Carcinoma - Prostatectomy - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Invasive Cribriform Carcinoma - Prostatectomy**

## Example Observation: Invasive Cribriform Carcinoma - Prostatectomy
...
```json
{
  ...
  "id" : "RadicalProstatectomyInvasiveCribriformCarcinoma",
  "meta" : {
    "profile" : [
    ...
    "coding" : [
      {
        ...
        "code" : "1162816009",
        "display" : "Invasive cribriform carcinoma (morphologic abnormality)"
      }
    ],
