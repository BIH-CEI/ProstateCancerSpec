# Tumornachweis Fettgewebe Stanze 07 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tumornachweis Fettgewebe Stanze 07**

## Example Observation: Tumornachweis Fettgewebe Stanze 07
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyTumornachweisInFettgewebe07",
  "meta" : {
    "profile" : [
