# Paraffinblock Stanze 05 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Paraffinblock Stanze 05**

## Example Specimen: Paraffinblock Stanze 05
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_24_001_E_1
...
**parent**: [Specimen: extension = ; identifier = Placer Identifier,Filler Identifier; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_24_001; status = available; type = Prostate tru-cut biopsy sample](Specimen-CoreNeedleBiopsySpecimen05Part.md)
...
| :--- | :--- | :--- |
| - | **Collected[x]** | **Method** |
| * | 2024-01-16 10:38:00+0100 | Gross examination and sampling of tissue specimen (procedure) |
...
```json
{
  ...
  "id" : "CoreNeedleBiopsySpecimen05Block",
  "meta" : {
    "profile" : [
