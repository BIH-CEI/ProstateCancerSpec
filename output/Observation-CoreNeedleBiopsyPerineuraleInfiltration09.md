# Perineurale Infiltration Stanze 09 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Perineurale Infiltration Stanze 09**

## Example Observation: Perineurale Infiltration Stanze 09
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyPerineuraleInfiltration09",
  "meta" : {
