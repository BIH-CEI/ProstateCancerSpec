# Sekundäres Gleason Muster Stanze 04 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Sekundäres Gleason Muster Stanze 04**

## Example Observation: Sekundäres Gleason Muster Stanze 04
...
```json
{
  ...
  "id" : "CoreNeedleBiopsySekundaerGleason04",
  "meta" : {
    "profile" : [
