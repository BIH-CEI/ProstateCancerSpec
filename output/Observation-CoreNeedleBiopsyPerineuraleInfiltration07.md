# Perineurale Infiltration Stanze 07 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Perineurale Infiltration Stanze 07**

## Example Observation: Perineurale Infiltration Stanze 07
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyPerineuraleInfiltration07",
  "meta" : {
    "profile" : [
