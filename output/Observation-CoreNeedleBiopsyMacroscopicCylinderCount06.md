# Anzahl Zylinder Stanze 06 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Anzahl Zylinder Stanze 06**

## Example Observation: Anzahl Zylinder Stanze 06
...
**specimen**: [Specimen: extension = ; identifier = Placer Identifier,Filler Identifier; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E2024_001; status = available; type = Prostate tru-cut biopsy sample](Specimen-CoreNeedleBiopsySpecimen06Part.md)
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyMacroscopicCylinderCount06",
  "meta" : {
    "profile" : [
