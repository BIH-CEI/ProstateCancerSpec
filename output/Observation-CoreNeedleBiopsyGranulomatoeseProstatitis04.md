# Granulomatöse Prostatitis Stanze 04 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Granulomatöse Prostatitis Stanze 04**

## Example Observation: Granulomatöse Prostatitis Stanze 04
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyGranulomatoeseProstatitis04",
  "meta" : {
    "profile" : [
