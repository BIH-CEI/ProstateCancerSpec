# HE-Schnitt Lymphknoten links 01 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HE-Schnitt Lymphknoten links 01**

## Example Specimen: HE-Schnitt Lymphknoten links 01
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_24_002_C_1_1HE
...
**parent**: [Specimen: identifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_24_002_C_1; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_24_002; status = available; type = General specimen container (physical object)](Specimen-RadicalProstatectomySpecimenLymphNodeLeftBlock.md)
...
| :--- | :--- | :--- |
| - | **Collected[x]** | **Method** |
| * | 2024-03-17 08:40:00+0100 | Tissue processing technique (procedure) |

> **processing****MII EX Biobank Temperaturbedingungen**: 2-8 °C**description**: Schnittherstellung**procedure**: Sectioning of tissue block**time**: 2024-03-17 09:40:00+0100

> **processing****MII EX Biobank Temperaturbedingungen**: 2-8 °C**description**: HE-Färbung**procedure**: Staining method**time**: 2024-03-17 09:55:00+0100
...
```json
{
  ...
  "id" : "RadicalProstatectomySpecimenLymphNodeLeftSlide01",
  "meta" : {
