# Grading Group according to ISUP 2014/WHO 2016 - TUR - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Grading Group according to ISUP 2014/WHO 2016 - TUR**

## Example Observation: Grading Group according to ISUP 2014/WHO 2016 - TUR
...
```json
{
  ...
  "id" : "TransurethralResectionGradingGroupISUP",
  "meta" : {
    "profile" : [
