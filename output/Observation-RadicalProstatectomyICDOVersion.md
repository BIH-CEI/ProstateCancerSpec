# ICD-O Version - Prostatectomy - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ICD-O Version - Prostatectomy**

## Example Observation: ICD-O Version - Prostatectomy
...
```json
{
  ...
  "id" : "RadicalProstatectomyICDOVersion",
  "meta" : {
    "profile" : [
