# Task V3 – In Bearbeitung (in-progress) - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Task V3 – In Bearbeitung (in-progress)**

## Example Task: Task V3 – In Bearbeitung (in-progress)
...
**lastModified**: 2024-01-16 08:00:00+0100
...
{
  "resourceType" : "Task",
  "id" : "CoreNeedleBiopsyTaskV3InProgress",
  "status" : "in-progress",
  "intent" : "order",
  "code" : {
    "coding" : [{
