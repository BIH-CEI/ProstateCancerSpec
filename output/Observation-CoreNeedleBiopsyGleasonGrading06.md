# Gradinggruppe ISUP Stanze 06 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Gradinggruppe ISUP Stanze 06**

## Example Observation: Gradinggruppe ISUP Stanze 06
...
**value**: Gleason grade group 1 (finding)

**bodySite**: Left posterolateral basal peripheral zone of prostate
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyGleasonGrading06",
  "meta" : {
  ...
  "valueCodeableConcept" : {
    "coding" : [{
      "system" : "http://snomed.info/sct",
      "code" : "860742008",
      "display" : "Gleason grade group 1 (finding)"
    }]
  },
  "bodySite" : {
    "coding" : [{
