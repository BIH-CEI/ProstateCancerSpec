# Extraprostatic Extension - TUR - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Extraprostatic Extension - TUR**

## Example Observation: Extraprostatic Extension - TUR
...
```json
{
  ...
  "id" : "TransurethralResectionExtraprostaticExtension",
  "meta" : {
    "profile" : [
