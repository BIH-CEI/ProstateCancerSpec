# Seitenangabe Stanze 11 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Seitenangabe Stanze 11**

## Example Observation: Seitenangabe Stanze 11
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyMacroscopicLaterality11",
  "meta" : {
    "profile" : [
