# Lymphovaskuläre Invasion Stanze 01 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Lymphovaskuläre Invasion Stanze 01**

## Example Observation: Lymphovaskuläre Invasion Stanze 01
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyLymphovaskulaereInvasion01",
  "meta" : {
    "profile" : [
