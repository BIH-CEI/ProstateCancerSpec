# Tumornachweis Samenblasen Stanze 02 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tumornachweis Samenblasen Stanze 02**

## Example Observation: Tumornachweis Samenblasen Stanze 02
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyTumornachweisinSamenblase02",
  "meta" : {
    "profile" : [
