# Paraffinblock 02 Prostata Enucleation - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Paraffinblock 02 Prostata Enucleation**

## Example Specimen: Paraffinblock 02 Prostata Enucleation
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E2024_004-Block-02
...
**parent**: [Specimen: identifier = Placer Identifier,Filler Identifier; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E2024_004; status = available; type = Surgical specimen](Specimen-TransurethralEnucleationSpecimenPart.md)
...
| :--- | :--- | :--- |
| - | **Collected[x]** | **Method** |
| * | 2024-04-11 10:35:00+0100 | Fixation of tissue (procedure) |
...
| * |  | Formalinfixierung und Paraffineinbettung | Fixation of tissue (procedure) | 2024-04-11 08:05:00+0100 |
...
```json
{
  ...
  "id" : "TransurethralEnucleationSpecimenBlock02",
  "meta" : {
    "profile" : [
