# Lymph Nodes Positive - Prostatectomy - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Lymph Nodes Positive - Prostatectomy**

## Example Observation: Lymph Nodes Positive - Prostatectomy
...
**value**: 0 lymph nodes (Details: UCUM code{LymphNodes} = '{LymphNodes}')
...
```json
{
  ...
  "id" : "RadicalProstatectomyLymphNodesPositive",
  "meta" : {
    "profile" : [
