# Paraffinblock Lymphknoten links - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Paraffinblock Lymphknoten links**

## Example Specimen: Paraffinblock Lymphknoten links
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_24_002_C_1
...
**parent**: [Specimen: identifier = Placer Identifier,Filler Identifier; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_24_002; status = available; type = Specimen from pelvic lymph node (specimen)](Specimen-RadicalProstatectomySpecimenLymphNodeLeft.md)
...
| :--- | :--- | :--- |
| - | **Collected[x]** | **Method** |
| * | 2024-03-16 11:05:00+0100 | Gross examination and sampling of tissue specimen |
...
| * |  | Zuschnitt und Paraffineinbettung | Preparation of formalin fixed paraffin embedded tissue specimen | 2024-03-16 09:05:00+0100 |
...
```json
{
  ...
  "id" : "RadicalProstatectomySpecimenLymphNodeLeftBlock",
  "meta" : {
