# Tumornachweis Fettgewebe Stanze 02 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tumornachweis Fettgewebe Stanze 02**

## Example Observation: Tumornachweis Fettgewebe Stanze 02
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyTumornachweisInFettgewebe02",
  "meta" : {
    "profile" : [
