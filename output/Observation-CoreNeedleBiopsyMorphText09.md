# Morphologie Freitext Stanze 09 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Morphologie Freitext Stanze 09**

## Example Observation: Morphologie Freitext Stanze 09
...
**value**: Azinäres Adenokarzinom mit vorwiegend Gleason Pattern 3, fokal Gleason Pattern 4. Mäßig differenziertes Karzinom.
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyMorphText09",
  "meta" : {
