# Lymphovascular Invasion - Enucleation - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Lymphovascular Invasion - Enucleation**

## Example Observation: Lymphovascular Invasion - Enucleation
...
```json
{
  ...
  "id" : "TransurethralEnucleationLymphovascularInvasion",
  "meta" : {
