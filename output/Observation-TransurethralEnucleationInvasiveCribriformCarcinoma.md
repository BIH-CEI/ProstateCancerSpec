# Invasive Cribriform Carcinoma - Enucleation - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Invasive Cribriform Carcinoma - Enucleation**

## Example Observation: Invasive Cribriform Carcinoma - Enucleation

Profile: [MII PR Patho Findingversion: null2026.0.0)](https://simplifier.net/resolve?scope=de.medizininformatikinitiative.kerndatensatz.patho@2026.0.0&canonical=https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-finding)

**basedOn**: [ServiceRequest Prostatectomy (procedure)](ServiceRequest-TransurethralEnucleationReportRequest.md)

**status**: Final

**category**: Laboratory, Pathology report final diagnosis Narrative

**code**: Invasive cribriform carcinoma
...
```json
{
  ...
  "id" : "TransurethralEnucleationInvasiveCribriformCarcinoma",
  "meta" : {
  ...
  "code" : {
    ...
    "text" : "Invasive cribriform carcinoma"
  },
  "subject" : {
