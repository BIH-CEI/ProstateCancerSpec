# Tumorbefall in Länge Stanze 01 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tumorbefall in Länge Stanze 01**

## Example Observation: Tumorbefall in Länge Stanze 01
...
**value**: 6.2 mm(Details: UCUM codemm = 'mm')
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyTumorbefallinLaenge01",
  "meta" : {
    "profile" : [
