# Morphologie Freitext Stanze 07 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Morphologie Freitext Stanze 07**

## Example Observation: Morphologie Freitext Stanze 07
...
**value**: Hochaggressives azinäres Adenokarzinom mit Gleason Pattern 4 und 5. Comedonecrosis, solid sheets, einzelne Zellen. Sehr schlechte Prognose.
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyMorphText07",
  "meta" : {
    "profile" : [
