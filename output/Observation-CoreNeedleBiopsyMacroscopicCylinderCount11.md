# Anzahl Zylinder Stanze 11 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Anzahl Zylinder Stanze 11**

## Example Observation: Anzahl Zylinder Stanze 11
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyMacroscopicCylinderCount11",
  "meta" : {
    "profile" : [
