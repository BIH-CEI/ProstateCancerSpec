# HE-Schnitt Stanze 06 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HE-Schnitt Stanze 06**

## Example Specimen: HE-Schnitt Stanze 06
...
**parent**: [Specimen: identifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_24_001_F_1; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_24_001; status = available; type = General specimen container (physical object)](Specimen-CoreNeedleBiopsySpecimen06Block.md)
...
```json
{
  ...
  "id" : "CoreNeedleBiopsySpecimen06Slide",
  "meta" : {
