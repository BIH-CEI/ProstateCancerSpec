# Lymphovaskuläre Invasion Stanze 02 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Lymphovaskuläre Invasion Stanze 02**

## Example Observation: Lymphovaskuläre Invasion Stanze 02
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyLymphovaskulaereInvasion02",
  "meta" : {
    "profile" : [
