# Intraductal Carcinoma - Enucleation - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Intraductal Carcinoma - Enucleation**

## Example Observation: Intraductal Carcinoma - Enucleation
...
```json
{
  ...
  "id" : "TransurethralEnucleationIntraductalCarcinoma",
  "meta" : {
