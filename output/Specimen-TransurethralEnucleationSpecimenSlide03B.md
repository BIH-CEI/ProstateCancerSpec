...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_24_004_A_3_2HE
...
**parent**: [Specimen: identifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_24_004_A_3; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_24_004; status = available; type = General specimen container (physical object)](Specimen-TransurethralEnucleationSpecimenBlock03.md)
...
| :--- | :--- | :--- |
| - | **Collected[x]** | **Method** |
| * | 2024-04-12 08:25:00+0100 | Staining method |
...
| * |  | HE-Färbung | Staining method | 2024-04-12 09:25:00+0100 |
