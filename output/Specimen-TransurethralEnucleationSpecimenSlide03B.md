# HE-Schnitt 03B Prostata Enucleation - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HE-Schnitt 03B Prostata Enucleation**

## Example Specimen: HE-Schnitt 03B Prostata Enucleation
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E2024_004-HE-03B
...
**parent**: [Specimen: identifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E2024_004-Block-03; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E2024_004; status = available; type = Paraffin block (physical object)](Specimen-TransurethralEnucleationSpecimenBlock03.md)
...
| :--- | :--- | :--- |
| - | **Collected[x]** | **Method** |
| * | 2024-04-12 08:25:00+0100 | Hematoxylin and eosin staining method (procedure) |
...
| * |  | HE-Färbung | Hematoxylin and eosin staining method (procedure) | 2024-04-12 09:25:00+0100 |
...
```json
{
  ...
  "id" : "TransurethralEnucleationSpecimenSlide03B",
  "meta" : {
    "profile" : [
