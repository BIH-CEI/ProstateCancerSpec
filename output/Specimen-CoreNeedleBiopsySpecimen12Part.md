# Prostatastanze 12 - Links medial apikal - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Prostatastanze 12 - Links medial apikal**

## Example Specimen: Prostatastanze 12 - Links medial apikal
...
* type: Structure of middle regional part of anterior fibromuscular stroma of left half prostate (body structure)
* description: Markiert mit türkiser Tinte

**identifier**: Placer Identifier/BX24_001_12_A, Filler Identifier/E2024_001-12-A
...
| * | [Practitioner Andreas Weber](Practitioner-UrologistPractitioner.md) | 2024-01-15 10:52:00+0100 | Tru-cut biopsy of prostate (procedure) | Structure of middle regional part of anterior fibromuscular stroma of left half prostate (body structure) |
...
```json
{
  ...
  "id" : "CoreNeedleBiopsySpecimen12Part",
  "meta" : {
    "profile" : [
  ...
  "extension" : [
    {
      "extension" : [
        ...
        {
          "url" : "description",
          "valueString" : "Markiert mit türkiser Tinte"
        }
      ],
