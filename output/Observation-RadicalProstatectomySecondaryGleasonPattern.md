# Secondary Gleason Pattern (Epstein 2005) - Prostatectomy - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Secondary Gleason Pattern (Epstein 2005) - Prostatectomy**

## Example Observation: Secondary Gleason Pattern (Epstein 2005) - Prostatectomy
...
```json
{
  ...
  "id" : "RadicalProstatectomySecondaryGleasonPattern",
  "meta" : {
    "profile" : [
