# Lymphovaskuläre Invasion Stanze 04 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Lymphovaskuläre Invasion Stanze 04**

## Example Observation: Lymphovaskuläre Invasion Stanze 04
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyLymphovaskulaereInvasion04",
  "meta" : {
    "profile" : [
