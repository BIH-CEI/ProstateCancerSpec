# High-grade PIN Stanze 11 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **High-grade PIN Stanze 11**

## Example Observation: High-grade PIN Stanze 11
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyHighGradePIN11",
  "meta" : {
