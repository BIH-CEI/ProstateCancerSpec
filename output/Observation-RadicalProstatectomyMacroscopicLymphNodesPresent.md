# Lymphknoten im Resektat - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Lymphknoten im Resektat**

## Example Observation: Lymphknoten im Resektat
...
**code**: Lymphknoten im Resektat

**subject**: [Peter Schmidt Male, DoB: 1960-03-22 ( http://example.hospital.de/patient-ids#PAT-2024-002)](Patient-Patient2.md)

**effective**: 2024-03-16 14:18:00+0100
...
```json
{
  ...
  "id" : "RadicalProstatectomyMacroscopicLymphNodesPresent",
  "meta" : {
    "profile" : [
  ...
  "note" : [
    {
      "text" : "Lymphknoten im Resektat vorhanden"
    }
  ],
  "bodySite" : {
    "coding" : [
