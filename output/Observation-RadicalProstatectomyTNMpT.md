# TNM Primary Tumor (pT) - Prostatectomy - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **TNM Primary Tumor (pT) - Prostatectomy**

## Example Observation: TNM Primary Tumor (pT) - Prostatectomy
...
**code**: Primary tumor.pathology Cancer
...
**value**: pT2c - Tumor involves both sides
    ...
    "coding" : [
      {
        ...
        "code" : "1229947008",
        "display" : "American Joint Committee on Cancer pT2c (qualifier value)"
      }
    ],
    "text" : "pT2c - Tumor involves both sides"
  },
  "specimen" : {
