# Lymphknoten-Dissektion im Enucleation-Resektat - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Lymphknoten-Dissektion im Enucleation-Resektat**

## Example Observation: Lymphknoten-Dissektion im Enucleation-Resektat
...
**code**: Lymphknoten-Dissektion Präparat

**subject**: [Peter Schmidt Male, DoB: 1960-03-22 ( http://example.hospital.de/patient-ids#PAT-2024-002)](Patient-Patient2.md)

**effective**: 2024-04-11 14:19:00+0100
...
```json
{
  ...
  "id" : "TransurethralEnucleationMacroscopicLymphNodeDissection",
  "meta" : {
    "profile" : [
  ...
  "code" : {
    ...
    "text" : "Lymphknoten-Dissektion Präparat"
  },
  "subject" : {
  ...
  "note" : [
    {
      "text" : "Keine Lymphknoten im Resektat"
    }
  ],
  "bodySite" : {
    "coding" : [
