# Granulomatöse Prostatitis Stanze 11 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Granulomatöse Prostatitis Stanze 11**

## Example Observation: Granulomatöse Prostatitis Stanze 11
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyGranulomatoeseProstatitis11",
  "meta" : {
