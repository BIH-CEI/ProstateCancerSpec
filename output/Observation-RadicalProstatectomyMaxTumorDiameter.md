# Maximum Tumor Diameter - Prostatectomy - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Maximum Tumor Diameter - Prostatectomy**

## Example Observation: Maximum Tumor Diameter - Prostatectomy
...
```json
{
  ...
  "id" : "RadicalProstatectomyMaxTumorDiameter",
  "meta" : {
    "profile" : [
