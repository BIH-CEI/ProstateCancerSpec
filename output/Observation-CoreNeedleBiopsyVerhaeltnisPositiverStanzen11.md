# Verhältnis positiver Stanzen 11 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Verhältnis positiver Stanzen 11**

## Example Observation: Verhältnis positiver Stanzen 11
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyVerhaeltnisPositiverStanzen11",
  "meta" : {
