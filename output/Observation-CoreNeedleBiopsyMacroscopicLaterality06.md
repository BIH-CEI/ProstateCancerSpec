# Seitenangabe Stanze 06 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Seitenangabe Stanze 06**

## Example Observation: Seitenangabe Stanze 06
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyMacroscopicLaterality06",
  "meta" : {
    "profile" : [
