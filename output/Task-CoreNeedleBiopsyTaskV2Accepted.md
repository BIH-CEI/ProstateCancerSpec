# Task V2 – Auftrag angenommen (accepted) - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Task V2 – Auftrag angenommen (accepted)**

## Example Task: Task V2 – Auftrag angenommen (accepted)
...
**executionPeriod**: 2024-01-15 14:00:00+0100 --> (ongoing)

**authoredOn**: 2024-01-15 08:00:00+0100

**lastModified**: 2024-01-15 14:00:00+0100
...
{
  "resourceType" : "Task",
  "id" : "CoreNeedleBiopsyTaskV2Accepted",
  "status" : "accepted",
  "intent" : "order",
  "code" : {
    "coding" : [{
