# Extraprostatic Extension - Enucleation - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Extraprostatic Extension - Enucleation**

## Example Observation: Extraprostatic Extension - Enucleation
...
```json
{
  ...
  "id" : "TransurethralEnucleationExtraprostaticExtension",
  "meta" : {
