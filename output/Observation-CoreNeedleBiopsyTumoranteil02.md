# Prozentualer Tumoranteil Stanze 02 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Prozentualer Tumoranteil Stanze 02**

## Example Observation: Prozentualer Tumoranteil Stanze 02
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyTumoranteil02",
  "meta" : {
    "profile" : [
