# PSA vor Prostata Enucleation - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **PSA vor Prostata Enucleation**

## Example Observation: PSA vor Prostata Enucleation
...
**effective**: 2024-05-05 08:00:00+0100
...
```json
{
  ...
  "id" : "TransurethralEnucleationPSAPre",
  "meta" : {
    "profile" : [
