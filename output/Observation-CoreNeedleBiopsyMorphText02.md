# Morphologie Freitext Stanze 02 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Morphologie Freitext Stanze 02**

## Example Observation: Morphologie Freitext Stanze 02
...
**value**: Azinäres Adenokarzinom mit überwiegend Gleason Pattern 4, fusion pattern und cribriform pattern.
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyMorphText02",
  "meta" : {
    "profile" : [
