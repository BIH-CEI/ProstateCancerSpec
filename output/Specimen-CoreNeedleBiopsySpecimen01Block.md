# Paraffinblock Stanze 01 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Paraffinblock Stanze 01**

## Example Specimen: Paraffinblock Stanze 01
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_24_001_A_1
...
**parent**: [Specimen: extension = ; identifier = Placer Identifier,Filler Identifier; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_24_001; status = available; type = Prostate tru-cut biopsy sample](Specimen-CoreNeedleBiopsySpecimen01Part.md)
...
| :--- | :--- | :--- |
| - | **Collected[x]** | **Method** |
| * | 2024-01-16 10:30:00+0100 | Gross examination and sampling of tissue specimen (procedure) |
...
```json
{
  ...
  "id" : "CoreNeedleBiopsySpecimen01Block",
  "meta" : {
    "profile" : [
