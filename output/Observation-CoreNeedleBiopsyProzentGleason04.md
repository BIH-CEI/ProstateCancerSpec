# Prozentualer Anteil Gleasonmuster 4/5 Stanze 04 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Prozentualer Anteil Gleasonmuster 4/5 Stanze 04**

## Example Observation: Prozentualer Anteil Gleasonmuster 4/5 Stanze 04
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyProzentGleason04",
  "meta" : {
    "profile" : [
