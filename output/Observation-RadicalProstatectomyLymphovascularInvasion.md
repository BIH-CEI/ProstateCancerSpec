# Lymphovascular Invasion - Prostatectomy - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Lymphovascular Invasion - Prostatectomy**

## Example Observation: Lymphovascular Invasion - Prostatectomy
...
```json
{
  ...
  "id" : "RadicalProstatectomyLymphovascularInvasion",
  "meta" : {
    "profile" : [
