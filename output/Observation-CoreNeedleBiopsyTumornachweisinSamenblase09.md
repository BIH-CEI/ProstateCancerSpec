# Tumornachweis Samenblasen Stanze 09 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tumornachweis Samenblasen Stanze 09**

## Example Observation: Tumornachweis Samenblasen Stanze 09
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyTumornachweisinSamenblase09",
  "meta" : {
