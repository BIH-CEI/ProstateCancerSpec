# Tumornachweis Samenblasen Stanze 07 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tumornachweis Samenblasen Stanze 07**

## Example Observation: Tumornachweis Samenblasen Stanze 07
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyTumornachweisinSamenblase07",
  "meta" : {
    "profile" : [
