# Verhältnis positiver Stanzen 07 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Verhältnis positiver Stanzen 07**

## Example Observation: Verhältnis positiver Stanzen 07
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyVerhaeltnisPositiverStanzen07",
  "meta" : {
    "profile" : [
