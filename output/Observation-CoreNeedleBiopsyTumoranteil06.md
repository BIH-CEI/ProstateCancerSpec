# Prozentualer Tumoranteil Stanze 06 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Prozentualer Tumoranteil Stanze 06**

## Example Observation: Prozentualer Tumoranteil Stanze 06
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyTumoranteil06",
  "meta" : {
