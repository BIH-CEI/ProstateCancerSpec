# Perineural Infiltration - TUR - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Perineural Infiltration - TUR**

## Example Observation: Perineural Infiltration - TUR
...
```json
{
  ...
  "id" : "TransurethralResectionPerineuralInfiltration",
  "meta" : {
    "profile" : [
