# Bladder Neck Invasion - Prostatectomy - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Bladder Neck Invasion - Prostatectomy**

## Example Observation: Bladder Neck Invasion - Prostatectomy
...
**code**: Bladder neck involvement of Prostate tumor
...
```json
{
  ...
  "id" : "RadicalProstatectomyBladderNeckInvasion",
  "meta" : {
    "profile" : [
    ...
    "coding" : [
      {
        "system" : "http://loinc.org",
        "code" : "84906-7",
        "display" : "Bladder neck involvement of Prostate tumor"
      }
    ]
  },
  "subject" : {
