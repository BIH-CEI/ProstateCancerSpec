# Prostatastanze 11 - Links medial mid - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Prostatastanze 11 - Links medial mid**

## Example Specimen: Prostatastanze 11 - Links medial mid
...
* type: Structure of middle regional part of transition zone of left half prostate (body structure)
* description: Markiert mit goldener Tinte

**identifier**: Placer Identifier/BX24_001_11_A, Filler Identifier/E2024_001-11-A
...
| * | [Practitioner Andreas Weber](Practitioner-UrologistPractitioner.md) | 2024-01-15 10:50:00+0100 | Tru-cut biopsy of prostate (procedure) | Structure of middle regional part of transition zone of left half prostate (body structure) |
...
```json
{
  ...
  "id" : "CoreNeedleBiopsySpecimen11Part",
  "meta" : {
    "profile" : [
  ...
  "extension" : [
    {
      "extension" : [
        ...
        {
          "url" : "description",
          "valueString" : "Markiert mit goldener Tinte"
        }
      ],
