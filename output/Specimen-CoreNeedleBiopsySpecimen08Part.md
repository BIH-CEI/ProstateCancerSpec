# Prostatastanze 08 - Links lateral mid - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Prostatastanze 08 - Links lateral mid**

## Example Specimen: Prostatastanze 08 - Links lateral mid
...
* type: Structure of lateral middle regional part of peripheral zone of left half prostate (body structure)
* description: Markiert mit brauner Tinte

**identifier**: Placer Identifier/BX24_001_08_A, Filler Identifier/E2024_001-08-A
...
| * | [Practitioner Andreas Weber](Practitioner-UrologistPractitioner.md) | 2024-01-15 10:44:00+0100 | Tru-cut biopsy of prostate (procedure) | Structure of lateral middle regional part of peripheral zone of left half prostate (body structure) |
...
```json
{
  ...
  "id" : "CoreNeedleBiopsySpecimen08Part",
  "meta" : {
    "profile" : [
  ...
  "extension" : [
    {
      "extension" : [
        ...
        {
          "url" : "description",
          "valueString" : "Markiert mit brauner Tinte"
        }
      ],
