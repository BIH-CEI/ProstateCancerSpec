# HE-Schnitt 02A Prostata Enucleation - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HE-Schnitt 02A Prostata Enucleation**

## Example Specimen: HE-Schnitt 02A Prostata Enucleation
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_24_004_A_2_1HE
...
```json
{
  ...
  "id" : "TransurethralEnucleationSpecimenSlide02A",
  "meta" : {
