# Perineurale Infiltration Stanze 06 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Perineurale Infiltration Stanze 06**

## Example Observation: Perineurale Infiltration Stanze 06
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyPerineuraleInfiltration06",
  "meta" : {
