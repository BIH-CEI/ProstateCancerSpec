# Primäres Gleason Muster Stanze 11 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Primäres Gleason Muster Stanze 11**

## Example Observation: Primäres Gleason Muster Stanze 11
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyPrimaerGleason11",
  "meta" : {
