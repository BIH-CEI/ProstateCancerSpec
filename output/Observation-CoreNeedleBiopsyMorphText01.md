# Morphologie Freitext Stanze 01 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Morphologie Freitext Stanze 01**

## Example Observation: Morphologie Freitext Stanze 01
...
**value**: Unregelmäßige, infiltrative Drüsenstrukturen, typisch für das azinäre Adenokarzinom. Gleason Pattern 3 mit fusion pattern (Pattern 4) kombiniert.
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyMorphText01",
  "meta" : {
    "profile" : [
