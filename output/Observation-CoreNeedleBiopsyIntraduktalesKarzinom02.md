# Intraduktales Karzinom Stanze 02 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Intraduktales Karzinom Stanze 02**

## Example Observation: Intraduktales Karzinom Stanze 02
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyIntraduktalesKarzinom02",
  "meta" : {
    "profile" : [
