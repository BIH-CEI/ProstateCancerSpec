# Tumornachweis Fettgewebe Stanze 01 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tumornachweis Fettgewebe Stanze 01**

## Example Observation: Tumornachweis Fettgewebe Stanze 01
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyTumornachweisInFettgewebe01",
  "meta" : {
    "profile" : [
