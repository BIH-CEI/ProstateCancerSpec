# Prozentualer Tumoranteil Stanze 07 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Prozentualer Tumoranteil Stanze 07**

## Example Observation: Prozentualer Tumoranteil Stanze 07
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyTumoranteil07",
  "meta" : {
    "profile" : [
