# Prostata Enucleation Länge - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Prostata Enucleation Länge**

## Example Observation: Prostata Enucleation Länge
...
**code**: Prostata Enucleation Länge

**subject**: [Peter Schmidt Male, DoB: 1960-03-22 ( http://example.hospital.de/patient-ids#PAT-2024-002)](Patient-Patient2.md)

**effective**: 2024-04-11 14:15:00+0100
...
Prostata Enucleation Länge: 3.5 cm
...
```json
{
  ...
  "id" : "TransurethralEnucleationMacroscopicLength",
  "meta" : {
    "profile" : [
  ...
  "code" : {
    ...
    "text" : "Prostata Enucleation Länge"
  },
  "subject" : {
  ...
  "note" : [
    {
      "text" : "Prostata Enucleation Länge: 3.5 cm"
    }
  ],
  "bodySite" : {
    "coding" : [
