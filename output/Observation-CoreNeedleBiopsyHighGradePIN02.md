# High-grade PIN Stanze 02 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **High-grade PIN Stanze 02**

## Example Observation: High-grade PIN Stanze 02
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyHighGradePIN02",
  "meta" : {
    "profile" : [
