# Perineurale Infiltration Stanze 02 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Perineurale Infiltration Stanze 02**

## Example Observation: Perineurale Infiltration Stanze 02
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyPerineuraleInfiltration02",
  "meta" : {
    "profile" : [
