# Anzahl Zylinder Stanze 09 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Anzahl Zylinder Stanze 09**

## Example Observation: Anzahl Zylinder Stanze 09
...
**bodySite**: Left apical peripheral zone of prostate

**specimen**: [Specimen: extension = ; identifier = Placer Identifier,Filler Identifier; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_24_001; status = available; type = Prostate tru-cut biopsy sample](Specimen-CoreNeedleBiopsySpecimen09Part.md)
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyMacroscopicCylinderCount09",
  "meta" : {
