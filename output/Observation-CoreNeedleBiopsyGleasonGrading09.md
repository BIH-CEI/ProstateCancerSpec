# Gradinggruppe ISUP Stanze 09 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Gradinggruppe ISUP Stanze 09**

## Example Observation: Gradinggruppe ISUP Stanze 09
...
**bodySite**: Right middle anterior fibromuscular stroma of prostate
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyGleasonGrading09",
  "meta" : {
