# Prostata Breite - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Prostata Breite**

## Example Observation: Prostata Breite
...
**code**: Prostata Breite

**subject**: [Peter Schmidt Male, DoB: 1960-03-22 ( http://example.hospital.de/patient-ids#PAT-2024-002)](Patient-Patient2.md)

**effective**: 2024-03-16 14:15:00+0100

**performer**: [Practitioner Maria Schneider](Practitioner-PathologistPractitioner.md)

**value**: 4.5 cm(Details: UCUM codecm = 'cm')

**note**: 

> 

Prostata Breite: 4.5 cm
...
```json
{
  ...
  "id" : "RadicalProstatectomyMacroscopicProstateWidth",
  "meta" : {
    "profile" : [
