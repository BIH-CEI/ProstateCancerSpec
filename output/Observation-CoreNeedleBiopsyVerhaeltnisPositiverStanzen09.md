# Verhältnis positiver Stanzen 09 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Verhältnis positiver Stanzen 09**

## Example Observation: Verhältnis positiver Stanzen 09
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyVerhaeltnisPositiverStanzen09",
  "meta" : {
