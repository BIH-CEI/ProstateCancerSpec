...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_24_002_A_2_2HE
...
**parent**: [Specimen: identifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_24_002_A_2; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_24_002; status = available; type = General specimen container (physical object)](Specimen-RadicalProstatectomySpecimenBlock02.md)
...
| :--- | :--- | :--- |
| - | **Collected[x]** | **Method** |
| * | 2024-03-17 08:15:00+0100 | Staining method |
...
| * |  | HE-Färbung | Staining method | 2024-03-17 09:15:00+0100 |
