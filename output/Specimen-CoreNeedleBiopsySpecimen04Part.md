# Prostatastanze 04 - Rechts medial basal - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Prostatastanze 04 - Rechts medial basal**

## Example Specimen: Prostatastanze 04 - Rechts medial basal
...
* type: Structure of basal part of anterior fibromuscular stroma of right half prostate (body structure)
* description: Markiert mit gelber Tinte

**identifier**: Placer Identifier/BX24_001_04_A, Filler Identifier/E2024_001-04-A
...
| * | [Practitioner Andreas Weber](Practitioner-UrologistPractitioner.md) | 2024-01-15 10:36:00+0100 | Tru-cut biopsy of prostate (procedure) | Structure of basal part of anterior fibromuscular stroma of right half prostate (body structure) |
...
```json
{
  ...
  "id" : "CoreNeedleBiopsySpecimen04Part",
  "meta" : {
    "profile" : [
  ...
  "extension" : [
    {
      "extension" : [
        ...
        {
          "url" : "description",
          "valueString" : "Markiert mit gelber Tinte"
        }
      ],
