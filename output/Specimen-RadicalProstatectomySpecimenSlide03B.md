# HE-Schnitt 03B Prostatektomie - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HE-Schnitt 03B Prostatektomie**

## Example Specimen: HE-Schnitt 03B Prostatektomie
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E2024_002-HE-03B
...
**parent**: [Specimen: identifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E2024_002-Block-03; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E2024_002; status = available; type = Paraffin block (physical object)](Specimen-RadicalProstatectomySpecimenBlock03.md)
...
| :--- | :--- | :--- |
| - | **Collected[x]** | **Method** |
| * | 2024-03-17 08:25:00+0100 | Hematoxylin and eosin staining method (procedure) |
...
| * |  | HE-Färbung | Hematoxylin and eosin staining method (procedure) | 2024-03-17 09:25:00+0100 |
...
```json
{
  ...
  "id" : "RadicalProstatectomySpecimenSlide03B",
  "meta" : {
    "profile" : [
