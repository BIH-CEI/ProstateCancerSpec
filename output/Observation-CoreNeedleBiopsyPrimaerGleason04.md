# Primäres Gleason Muster Stanze 04 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Primäres Gleason Muster Stanze 04**

## Example Observation: Primäres Gleason Muster Stanze 04
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyPrimaerGleason04",
  "meta" : {
    "profile" : [
