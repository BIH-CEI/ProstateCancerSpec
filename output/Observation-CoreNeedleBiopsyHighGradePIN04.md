# High-grade PIN Stanze 04 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **High-grade PIN Stanze 04**

## Example Observation: High-grade PIN Stanze 04
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyHighGradePIN04",
  "meta" : {
    "profile" : [
