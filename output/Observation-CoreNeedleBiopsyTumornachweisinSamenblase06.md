# Tumornachweis Samenblasen Stanze 06 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tumornachweis Samenblasen Stanze 06**

## Example Observation: Tumornachweis Samenblasen Stanze 06
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyTumornachweisinSamenblase06",
  "meta" : {
