# Perineurale Infiltration Stanze 01 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Perineurale Infiltration Stanze 01**

## Example Observation: Perineurale Infiltration Stanze 01
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyPerineuraleInfiltration01",
  "meta" : {
    "profile" : [
