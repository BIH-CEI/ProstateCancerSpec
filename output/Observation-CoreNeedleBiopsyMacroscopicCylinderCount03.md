# Anzahl Zylinder Stanze 03 - Prostate Cancer Specification v0.1.0
...
**specimen**: [Specimen: extension = ; identifier = Placer Identifier,Filler Identifier; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_24_001; status = available; type = Prostate tru-cut biopsy sample](Specimen-CoreNeedleBiopsySpecimen03Part.md)
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyMacroscopicCylinderCount03",
  "meta" : {
    "profile" : [
