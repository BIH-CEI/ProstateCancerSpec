# Perineurale Infiltration Stanze 04 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Perineurale Infiltration Stanze 04**

## Example Observation: Perineurale Infiltration Stanze 04
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyPerineuraleInfiltration04",
  "meta" : {
    "profile" : [
