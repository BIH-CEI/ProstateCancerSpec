# Lymphovascular Invasion - Biopsy - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Lymphovascular Invasion - Biopsy**

## Example Observation: Lymphovascular Invasion - Biopsy
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyLymphovascularInvasion",
  "meta" : {
    "profile" : [
