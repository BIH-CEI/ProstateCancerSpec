# Lymphovaskuläre Invasion Stanze 07 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Lymphovaskuläre Invasion Stanze 07**

## Example Observation: Lymphovaskuläre Invasion Stanze 07
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyLymphovaskulaereInvasion07",
  "meta" : {
    "profile" : [
