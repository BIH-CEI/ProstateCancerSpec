# HE-Schnitt 01A Prostatektomie - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HE-Schnitt 01A Prostatektomie**

## Example Specimen: HE-Schnitt 01A Prostatektomie
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E2024_002-HE-01A
...
**parent**: [Specimen: identifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E2024_002-Block-01; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E2024_002; status = available; type = Paraffin block (physical object)](Specimen-RadicalProstatectomySpecimenBlock01.md)
...
| :--- | :--- | :--- |
| - | **Collected[x]** | **Method** |
| * | 2024-03-17 08:00:00+0100 | Hematoxylin and eosin staining method (procedure) |
...
| * |  | HE-Färbung | Hematoxylin and eosin staining method (procedure) | 2024-03-17 09:00:00+0100 |
...
```json
{
  ...
  "id" : "RadicalProstatectomySpecimenSlide01A",
  "meta" : {
    "profile" : [
