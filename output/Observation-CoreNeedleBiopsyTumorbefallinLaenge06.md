# Tumorbefall in Länge Stanze 06 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tumorbefall in Länge Stanze 06**

## Example Observation: Tumorbefall in Länge Stanze 06
...
**value**: 3.1 mm (Details: UCUM codemm = 'mm')
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyTumorbefallinLaenge06",
  "meta" : {
