# Histological Type ICD-O-3 - Prostatectomy - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Histological Type ICD-O-3 - Prostatectomy**

## Example Observation: Histological Type ICD-O-3 - Prostatectomy
...
```json
{
  ...
  "id" : "RadicalProstatectomyHistologicalTypeICDO3",
  "meta" : {
    "profile" : [
