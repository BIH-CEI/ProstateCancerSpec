# Prostata Enucleation Breite - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Prostata Enucleation Breite**

## Example Observation: Prostata Enucleation Breite
...
**code**: Prostata Enucleation Breite

**subject**: [Klaus Becker Male, DoB: 1958-11-10 ( http://example.hospital.de/patient-ids#PAT-2024-003)](Patient-Patient3.md)

**effective**: 2024-04-11 14:16:00+0100

**performer**: [Practitioner Maria Schneider ](Practitioner-PathologistPractitioner.md)

**value**: 2.8 cm (Details: UCUM codecm = 'cm')

**note**: 

> 

Prostata Enucleation Breite: 2.8 cm
...
```json
{
  ...
  "id" : "TransurethralEnucleationMacroscopicWidth",
  "meta" : {
    "profile" : [
  ...
  "code" : {
    ...
    "text" : "Prostata Enucleation Breite"
  },
  "subject" : {
  ...
  "note" : [
    {
      "text" : "Prostata Enucleation Breite: 2.8 cm"
    }
  ],
  "bodySite" : {
    "coding" : [
