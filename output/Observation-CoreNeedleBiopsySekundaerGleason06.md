# Sekundäres Gleason Muster Stanze 06 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Sekundäres Gleason Muster Stanze 06**

## Example Observation: Sekundäres Gleason Muster Stanze 06
...
```json
{
  ...
  "id" : "CoreNeedleBiopsySekundaerGleason06",
  "meta" : {
