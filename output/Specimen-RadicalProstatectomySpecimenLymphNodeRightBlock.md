# Paraffinblock Lymphknoten rechts - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Paraffinblock Lymphknoten rechts**

## Example Specimen: Paraffinblock Lymphknoten rechts
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_24_002_B_1
...
**parent**: [Specimen: identifier = Placer Identifier,Filler Identifier; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_24_002; status = available; type = Specimen from pelvic lymph node (specimen)](Specimen-RadicalProstatectomySpecimenLymphNodeRight.md)
...
| :--- | :--- | :--- |
| - | **Collected[x]** | **Method** |
| * | 2024-03-16 11:00:00+0100 | Gross examination and target selection of tissue specimen (procedure) |
...
| * |  | Zuschnitt und Paraffineinbettung | Preparation of formalin-fixed paraffin-embedded tissue specimen (procedure) | 2024-03-16 09:00:00+0100 |
...
```json
{
  ...
  "id" : "RadicalProstatectomySpecimenLymphNodeRightBlock",
  "meta" : {
    "profile" : [
      ...
      "coding" : [
        {
          "system" : "http://snomed.info/sct",
          "code" : "787377000",
          "display" : "Gross examination and target selection of tissue specimen (procedure)"
        }
      ]
    }
  },
