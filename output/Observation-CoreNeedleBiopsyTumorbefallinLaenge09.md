# Tumorbefall in Länge Stanze 09 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tumorbefall in Länge Stanze 09**

## Example Observation: Tumorbefall in Länge Stanze 09
...
**value**: 4.5 mm (Details: UCUM codemm = 'mm')
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyTumorbefallinLaenge09",
  "meta" : {
