# Primäres Gleason Muster Stanze 07 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Primäres Gleason Muster Stanze 07**

## Example Observation: Primäres Gleason Muster Stanze 07
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyPrimaerGleason07",
  "meta" : {
    "profile" : [
