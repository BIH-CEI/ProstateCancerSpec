# Prozentualer Tumoranteil Stanze 01 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Prozentualer Tumoranteil Stanze 01**

## Example Observation: Prozentualer Tumoranteil Stanze 01
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyTumoranteil01",
  "meta" : {
    "profile" : [
