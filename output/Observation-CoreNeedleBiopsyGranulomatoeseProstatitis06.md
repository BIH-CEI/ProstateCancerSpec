# Granulomatöse Prostatitis Stanze 06 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Granulomatöse Prostatitis Stanze 06**

## Example Observation: Granulomatöse Prostatitis Stanze 06
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyGranulomatoeseProstatitis06",
  "meta" : {
