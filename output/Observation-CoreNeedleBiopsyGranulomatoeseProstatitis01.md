# Granulomatöse Prostatitis Stanze 01 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Granulomatöse Prostatitis Stanze 01**

## Example Observation: Granulomatöse Prostatitis Stanze 01
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyGranulomatoeseProstatitis01",
  "meta" : {
    "profile" : [
