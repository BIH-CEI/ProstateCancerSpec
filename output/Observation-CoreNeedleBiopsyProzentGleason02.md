# Prozentualer Anteil Gleasonmuster 4/5 Stanze 02 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Prozentualer Anteil Gleasonmuster 4/5 Stanze 02**

## Example Observation: Prozentualer Anteil Gleasonmuster 4/5 Stanze 02
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyProzentGleason02",
  "meta" : {
    "profile" : [
