# Morphology Free Text Description - Prostatectomy - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Morphology Free Text Description - Prostatectomy**

## Example Observation: Morphology Free Text Description - Prostatectomy
...
**value**: Konventionelles Adenokarzinom der Prostata mit gemischten Gleason-Mustern
...
```json
{
  ...
  "id" : "RadicalProstatectomyMorphologyFreeText",
  "meta" : {
    "profile" : [
