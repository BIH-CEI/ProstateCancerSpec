# Secondary Gleason Pattern (Epstein 2005) - TUR - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Secondary Gleason Pattern (Epstein 2005) - TUR**

## Example Observation: Secondary Gleason Pattern (Epstein 2005) - TUR
...
```json
{
  ...
  "id" : "TransurethralResectionSecondaryGleasonPattern",
  "meta" : {
    "profile" : [
