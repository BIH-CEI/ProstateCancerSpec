# Granulomatöse Prostatitis Stanze 09 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Granulomatöse Prostatitis Stanze 09**

## Example Observation: Granulomatöse Prostatitis Stanze 09
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyGranulomatoeseProstatitis09",
  "meta" : {
