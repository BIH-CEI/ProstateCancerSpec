# Number of Positive Cores Right Side - Biopsy - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Number of Positive Cores Right Side - Biopsy**

## Example Observation: Number of Positive Cores Right Side - Biopsy
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyPositiveCoresRight",
  "meta" : {
    "profile" : [
