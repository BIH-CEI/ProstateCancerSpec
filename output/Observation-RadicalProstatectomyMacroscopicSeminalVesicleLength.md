# Samenbläschenlänge - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Samenbläschenlänge**

## Example Observation: Samenbläschenlänge
...
**effective**: 2024-03-16 14:20:00+0100

**performer**: [Practitioner Maria Schneider ](Practitioner-PathologistPractitioner.md)

**value**: Rechts 2.5 cm, Links 2.5 cm

**note**: 

> 

Beide Samenbläschen je 2.5 cm lang


**bodySite**: Seminal vesicle structure (body structure)
...
```json
{
  ...
  "id" : "RadicalProstatectomyMacroscopicSeminalVesicleLength",
  "meta" : {
    "profile" : [
  ...
  "note" : [
    {
      "text" : "Beide Samenbläschen je 2.5 cm lang"
    }
  ],
  "bodySite" : {
    "coding" : [
