# Primäres Gleason Muster Stanze 01 - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Primäres Gleason Muster Stanze 01**

## Example Observation: Primäres Gleason Muster Stanze 01
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyPrimaerGleason01",
  "meta" : {
    "profile" : [
