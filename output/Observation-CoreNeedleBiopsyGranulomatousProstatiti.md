# Granulomatous Prostatitis - Biopsy - Prostate Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Granulomatous Prostatitis - Biopsy**

## Example Observation: Granulomatous Prostatitis - Biopsy
...
**code**: Granulomatous prostatitis
...
```json
{
  ...
  "id" : "CoreNeedleBiopsyGranulomatousProstatiti",
  "meta" : {
    "profile" : [
    ...
    "coding" : [
      {
        "system" : "http://loinc.org",
        "code" : "94665-7",
        "display" : "Granulomatous prostatitis"
      }
    ]
  },
  "subject" : {
