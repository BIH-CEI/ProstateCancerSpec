...
| Observation.code | Display | value[x] | Value Domain | Scenario |
|---|---|---|---|---|
...
| Observation.code | Display | value[x] | Value Domain |
|---|---|---|---|
...
| Code | System | Display (Prostate context) | BfArM Display (official) |
|---|---|---|---|
