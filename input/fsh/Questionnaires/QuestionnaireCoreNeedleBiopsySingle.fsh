...
Usage: #example
* meta.lastUpdated = "2025-06-10T13:31:49Z"
...
* item.item[=].item[=].item[=].text = "* Verwendung für jeden einzelnen Stanzzylinder oder Verwendung für jeden einzelnen Stanzzylinder oder * Berichterstattung auf Probenebene kann für jeden positiven Probenort verwendet werden, wodurch mehrere Berichte generiert werden. Berichterstattung auf Probenebene kann für jeden positiven Probenort verwendet werden, wodurch mehrere Berichte generiert werden."
