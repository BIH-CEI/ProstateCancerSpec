...
* author = Reference(TransurethralEnucleationPathLabOrganization)
...
* attester.mode = #legal
* attester.party = Reference(TransurethralEnucleationPathLabOrganization)
* custodian = Reference(TransurethralEnucleationPathLabOrganization)
* event.code = http://terminology.hl7.org/CodeSystem/v3-ActCode#PATREPE
* event.detail = Reference(TransurethralEnucleationServiceRequest)
