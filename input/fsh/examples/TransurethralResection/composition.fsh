...
* author = Reference(TransurethralResectionPathLabOrganization)
...
* attester.mode = #legal
* attester.party = Reference(TransurethralResectionPathLabOrganization)
* custodian = Reference(TransurethralResectionPathLabOrganization)
